                    ...
                    <div class="product-slider owl-carousel">
                        <div class="product-item">
                            <div class="pi-pic">
                                	...
                                	<img style="width:300px; height:320px;" src="${pageContext.request.contextPath}/resources/productImg/${topList[0].pImageName}" alt="">
                                </a>
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <img style="width:300px; height:320px;" src="${pageContext.request.contextPath}/resources/productImg/${topList[1].pImageName}" alt="">
                              </a>
                            </div>
                            <div class="pi-text">
                        ...
                        <div class="product-item">
                            <div class="pi-pic">
                                ...
                                <img style="width:300px; height:320px;" src="${pageContext.request.contextPath}/resources/productImg/${topList[2].pImageName}" alt="">
                            	</a>
                            </div>
                            <div class="pi-text">
                        ...
                        <div class="product-item">
                            ...
                            <a href="productInfo.do?num=${topList[3].pNum}" style="color:black; font-weight:bold;">
                                <img style="width:300px; height:320px;" src="${pageContext.request.contextPath}/resources/productImg/${topList[3].pImageName}" alt="">
                             </a>
                            </div>
                            <div class="pi-text">
