        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 order-1 order-lg-2">
                   <form method="post" action="qaView.do" role="form">
	                <div align="center">비밀번호를 입력해주세요</div><br>
		             <input type="password" class="form-control" name="inputPw" name="inputPw" placeholder="비밀번호를 입력하세요">
	                <br><br>
	                <div align="center">
	                	<input type="submit" id="btn_write" class="btn btn-warning" value="확인">
	                ...
	                <input type="hidden" name="selectMenu" value="${selectMenu }">
