...
<body>
                                 ...
                                 <c:if test="${!empty review}">
                                    ...
                                    <c:set var="rNum" value="${review.rNum}"/>
                                       ...
                                       <c:if test="${review.rWriter == sessionScope.member.getUserId()}">
                                          ...
                                          <!-- 리뷰 수정 폼 -->
                                          <div id="reUpdateForm${rNum}" class="reComment leave-comment" style="display: none;">
                                             ...
                                             <div class="row">
                                                <div class="col-lg-12">
                                                   ...
                                                   <textarea name="rContent" id="rContent2">${review.rContent}</textarea>
                                                      ...
                                                      <div style="margin-bottom: 20px;">
                                                         <input type="file" id="userFile2${rNum}" onchange="reUpdateFile(${rNum})" value="사진 업로드" onchangemultiple/>
                                                      </div>
                                                      <div class="recenter">
   ...
   <script>
     ...
     /*      $('file[id^=userFile2]').on('change',function() {
               alert($(this).prop('id'));
               reUpdateFile();
               //reUpdateList
            } ); */
...
/*       //리뷰 수정
     $('#reUpdateBtn'+idNum).on('click',reUpdateList); */
      // 리뷰 수정할 때 새로운 파일
     function reUpdateFile(inm){
    	 console.log(inm);
         userfile2 = $('#userFile2'+inm);
