...
public class NaverController {
   ...
   private final static String CLIENT_ID = "1anWDyUmMzIT3OmLrpYG";
   private final static String CLIENT_SECRET = "BQskca3zL9";
   private final static String REDIRECT_URI = "http://localhost:8282/herb/naverLogin.do";
